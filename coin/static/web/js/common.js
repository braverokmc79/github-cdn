...
$( document ).ready(function() {
			...
			//서머노트 이미지 클릭시 로테이션으로 변경하기
		$('.board-view-desc img').on({'click': function() {
		         var src = $(this).attr('src');
		         const link=src.replace('/displayFile?fileName', 'displayFile?fileName');
		         console.log(link);
		         $(this).attr('src', link);
		         const $this=this;
		         setTimeout(()=>{
